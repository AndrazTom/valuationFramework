...
- Cross-sector sweep note:
  ...
  - external QA against StockAnalysis quarterly pages on 2026-04-10:
    - AAPL and JPM line up well on the main displayed income rows
    ...
    - UNH has small vendor-vs-companyfacts differences on net income; keep the shareholder-oriented SEC line unless a better generic rule is proven

## International Notes

- As of 2026-04-10, `intl-markets` proves that non-US support does not require a total rewrite
